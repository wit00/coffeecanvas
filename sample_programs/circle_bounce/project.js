(function() {
  var Bitmap, BoundaryManager, Circle, CollisionManager, ColorTween, Curve, GameLoop, Gradient, KeyManager, Line, Matrix, Pattern, Polygon, Rectangle, RoundedRectangle, Scene, Shape, Sprite, Square, Star, Text, Triangle, Tween, collisions, f, gameLoop, include, namespace, obj1, obj2, obj3, obj4, obj5, scene,
  ...
  obj1.addEvent({
    ...
    objectType: "boundary",
    toDo: f = function() {
      return CollisionResponse.randomBounce(obj1);
    }
  });
  ...
  obj2.addEvent({
    ...
    objectType: "boundary",
    toDo: f = function() {
      return CollisionResponse.randomBounce(obj2);
    }
  });
  ...
  obj3.addEvent({
    ...
    objectType: "boundary",
    toDo: f = function() {
      return CollisionResponse.randomBounce(obj3);
    }
  });
  ...
  obj4.addEvent({
    ...
    objectType: "boundary",
    toDo: f = function() {
      return CollisionResponse.randomBounce(obj4);
    }
  });
  ...
  obj5.addEvent({
    ...
    objectType: "boundary",
    toDo: f = function() {
      return CollisionResponse.randomBounce(obj5);
    }
  });
