(function() {
  var Bitmap, Circle, CollisionManager, ColorTween, Curve, GameLoop, Gradient, KeyManager, Line, Matrix, Pattern, Polygon, Rectangle, RoundedRectangle, Scene, Shape, Sprite, Square, Star, Text, Triangle, Tween, b1, collisions, f, gameLoop, include, keys, namespace, scene, square1, square2, stop, test, test2, tween,
  ...
  Sprite = (function() {
      ...
      if (change === "delete") {
        ...
        switch (tween.attribute) {
          case "x":
            delt = this.x - change;
            this.x = change;
            return this.adjustedX = change;
          case "y":
            delt = this.y - change;
            this.y = change;
            return this.adjustedY = change;
          case "rotation":
    ...
    Sprite.prototype.update = function() {
      ...
      if (this.rotation > 6.28) return this.rotation = 0.1;
    };
    ...
    Sprite.prototype.addEvent = function(args) {
      ...
      if (type instanceof CollisionManager) {
        ...
        if (args.detail === true) type.turnOnDetail();
        newEvent = {
          type: type,
  ...
  CollisionManager = (function() {
    ...
    CollisionManager.prototype.turnOnDetail = function() {
      ...
      for (_i = 0, _len = pixels1.length, _step = 3; _i < _len; _i += _step) {
        ...
        for (_j = 0, _len2 = pixels2.length, _step2 = 3; _j < _len2; _j += _step2) {
          ...
          if (pixel1 > 0 && pixel2 > 0) {
            if (this.detail === true) {
              this.generatePoints(xDiff, yDiff, xMin, yMin, o1, o2);
              return true;
            } else {
              return true;
            }
    ...
    CollisionManager.prototype.generatePoints = function(xDiff, yDiff, xMin, yMin, o1, o2) {
      ...
      if (isColliding === true) {
        ...
        this.drawAtCollide(o1, (mid + 1) / o1.time + 1);
        return true;
      }
    };

    CollisionManager.prototype.moveBackBoundary = function(o1) {
      var isColliding, max, mid, midValue, min, moment, time;
      min = 0;
      max = o1.time - 1;
      mid = 0;
      ...
      while (min <= max) {
        mid = Math.floor((min + max) / 2);
        moment = mid / time;
        isColliding = this.testBound(o1, moment);
        if (isColliding === false) min = mid + 1;
        if (isColliding === true) max = mid - 1;
      }
      if (isColliding === true) {
        o1.collideTime = mid;
        this.drawAtCollide(o1, mid / o1.time + 1);
        return true;
      } else {
        o1.collideTime = mid + 1;
        this.drawAtCollide(o1, (mid + 1) / o1.time + 1);
    ...
    CollisionManager.prototype.testBound = function(o1, moment) {
      var canvas, h, w, x, xMax, xMin, y, yMax, yMin;
      canvas = document.getElementById("myCanvas");
    ...
    CollisionManager.prototype.runCollisionDetection = function(sprite) {
      var index, isCorrectType, object, subSprite, type, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _results;
      _ref = this.typesToTest.sprite;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        type = _ref[_i];
        if (type === "boundary") {
          if (this.hitsBoundary(sprite) === true) {
            this.moveBackBoundary(sprite);
            this.collided.push({
              o1: sprite,
              o2: "boundary"
            });
  ...
  test = function(o) {
    if (o.y > 350 || o.y < 40) o.yVelocity = o.yVelocity * -1;
    if (o.x >= 650 || o.x <= 40) return o.xVelocity = o.xVelocity * -1;
  };
